...
namespace DACHUYENNGANH.Areas.Admin.Controllers
{
    ...
    public class KhachHangCaNhansController : Controller
    {
        ...
        // GET: Admin/KhachHangCaNhans/Details/5
        ...
        // GET: Admin/KhachHangCaNhans/Create
        ...
        // POST: Admin/KhachHangCaNhans/Create
        ...
        public async Task<IActionResult> Create([Bind("NgaySinh,IdKhachHang,DiaChi,GioiTinh,Sdt,CmndCccd,TenKh,IdKhachHangCaNhan")] KhachHangCaNhan khachHangCaNhan)
        {
            ...
            {
                khachHangCaNhan.IdKhachHangCaNhan = GetIDKHCN.GetIDByFullNameAnDobKHCN(khachHangCaNhan.TenKh, khachHangCaNhan.NgaySinh);
                _context.Add(khachHangCaNhan);
                _context.Add(khachHangCaNhan);
                await _context.SaveChangesAsync();
                return RedirectToAction(nameof(Index));
            }
            ViewData["IdKhachHang"] = new SelectList(_context.KhachHangs, "IdKhachHang", "MaSoThue", khachHangCaNhan.IdKhachHang);
            return View(khachHangCaNhan);
        }

        // GET: Admin/KhachHangCaNhans/Edit/5
        ...
        // POST: Admin/KhachHangCaNhans/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/KhachHangCaNhans/Delete/5
        ...
        // POST: Admin/KhachHangCaNhans/Delete/5
